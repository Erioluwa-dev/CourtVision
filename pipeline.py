...
The full per-frame pipeline: detection (players / ball / rim / court)
-> tracking -> homography -> zones -> heatmaps -> team classification
-> stats -> possession -> passes -> shots -> commentary, plus optional
export of frames, summary and heatmaps to an output directory.
"""
